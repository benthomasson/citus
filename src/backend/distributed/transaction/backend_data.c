...
assign_distributed_transaction_id(PG_FUNCTION_ARGS)
{
	...
	MyBackendData->transactionId.transcationStartedOnNode = false;
...
GetCurrentDistributedTransactionId(void)
{
	...
	currentDistributedTransactionId->transcationStartedOnNode =
		MyBackendData->transactionId.transcationStartedOnNode;
...
AssignDistributedTransactionId(void)
{
	...
	MyBackendData->transactionId.transcationStartedOnNode = true;
	MyBackendData->transactionId.transactionNumber =
